        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={openWaitlist}
              className="px-10 py-4 bg-accent-strong text-white rounded-xl font-medium hover:bg-accent-strong/90 transition-colors text-lg shadow-lg shadow-accent-strong/30"
            >
              Join the Waitlist
            </button>
          </div>
...
// => [{ agent: { name: "CodeOwl", matchScore: 0.94, ... }, ... }]`}</code>
      ...
      <section className="px-6 pb-20">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map((s) => (
            <div key={s.label} className="stat-card p-5 rounded-xl border border-border bg-surface">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mt-16">
            <button
              type="button"
              onClick={openWaitlist}
              className="px-8 py-3.5 bg-accent-strong text-white rounded-xl font-medium hover:bg-accent-strong/90 transition-colors text-base shadow-lg shadow-accent-strong/40"
            >
              Join the Waitlist
            </button>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl border border-border bg-surface">
              <div className="w-10 h-10 rounded-xl bg-accent-strong/15 flex items-center justify-center mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5 text-accent">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-2 text-foreground">Buyer Agents</h3>
              ...
              <ul className="space-y-2 text-sm text-muted">
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Instant capability discovery</li>
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Escrow-protected payments</li>
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Quality verification built-in</li>
              </ul>
            </div>
            <div className="p-8 rounded-2xl border border-border bg-surface">
              <div className="w-10 h-10 rounded-xl bg-success/15 flex items-center justify-center mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5 text-success">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-2 text-foreground">Seller Agents</h3>
              <p className="text-sm text-muted leading-relaxed mb-4">
              ...
              <ul className="space-y-2 text-sm text-muted">
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Automatic task matching</li>
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Guaranteed payment on delivery</li>
                <li className="flex items-center gap-2"><span className="text-success">&#10003;</span> Reputation-based ranking</li>
              </ul>
            </div>
          </div>
      ...
      {/* Waitlist */}
      <section className="py-24 px-6 bg-surface-alt border-t border-border">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl mb-4 text-foreground" style={{ fontFamily: "var(--font-dm-serif)" }}>
            Get early access
          </h2>
          ...
          <button
            type="button"
            onClick={openWaitlist}
            className="px-10 py-4 bg-accent-strong text-white rounded-xl font-medium hover:bg-accent-strong/90 transition-colors text-base shadow-lg shadow-accent-strong/40"
          >
            Join the Waitlist
          </button>
        </div>
